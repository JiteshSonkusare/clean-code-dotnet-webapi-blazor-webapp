...
namespace WebAPI.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        internal static void AddGrapQLDependencies(this IServiceCollection services)
        {
            services.AddRouting()
                    .AddGraphQLServer()
                    .AddProjections()
        ...
        internal static IServiceCollection AddDatabaseDependencies(
        ...
        internal static void IsAuthenticated(this IApplicationBuilder app)
        {
